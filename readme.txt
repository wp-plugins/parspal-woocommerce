...
Tags: woocommerce, commerce, e-commerce, commerce, shop, virtual shop, ParsPal bank, ParsPal, iran, persian, farsi,woocommerce persian, e-commerce, ووکامرس, ووکامرس فارسی,ParsPal woocommerce,بانک پارس پال,درگاه پرداخت,payment gateway,ParsPal,woocommerce payment
Requires at least: 4.0
Tested up to: 4.2

پرداخت اینترنتی وجه به وسیله درگاه پرداخت واسطه پارس پال

== Description ==
**Woocommerce ParsPal Gateway** این افزونه شما را قادر می سازد تا براحتی اقدام به ایجاد درگاه پرداخت اینترنتی بانک پارس پال برای پرداخت های محصولات ووکامرس کنید
 ...
 * قابلیت نمایش کد رهگیری و شماره ارجاع بانک پارس پال همراه با کد میانبر
 * نمایش خطاهای درگاه پرداخت
 * قابلیت پرداخت بر اساس واحد پولی ریال و یا تومان
...
== Installation ==
1. پوشه `ParsPal-woocommerce` را در مسیر `/wp-content/plugins/` آپلود کنید
